...
public class Login {
    ...
    public boolean checkUserName(String userName){
        //We using a for loop to search each character if they have the specific characters needed in the requirement
        ...
        //Here we are conduting a test where we take the user's input length and test it if it matches with the requirement 
     ...
     public boolean checkPassWordComplexity(String password){
         //Now we testing if the input has a Cap Character, a number and a specialCharacter like @ to fit the Password Complexity
         boolean cap=false;
         boolean number=false;
        boolean specialChar=false;
        //Using a For loop again to check each character
     ...
     public String registerUser(String username, String password){
         ...
         //Here we're gonna take all the necessary data from the user and see if it passed all the necessary tasks needed if not we will project an output stating what's messsing
     ...
     public boolean loginUser(String username, String password, String loginUsername, String loginPassword){
         //This is where we check if the data we stored from the user is the same as the one they input to register with if not we project the outcome to them
     ...
     public String returnLoginStatus(String first,String last,String username, String password, String loginUsername, String loginPassword){
         //After the registeration test has been successful,we then lend to the logging state where if the values are true we view their account
    ...
    public static void main(String[] args) {
        // Here we are making a link opening after the login feature is complete and move to the next screen
       ...
       String logUsername= JOptionPane.showInputDialog(null,"Please enter the username to login");
        ...
        if(count==3){
            ...
            JOptionPane.showMessageDialog(null,"The total hours \n"+task.returnTotalHours());
                ...
                boolean t=true;
                while(t){
                int value=Integer.parseInt(JOptionPane.showInputDialog(null, " 1) Display the Developer, Task Names and Task Duration for all tasks with the status of done.\n "
